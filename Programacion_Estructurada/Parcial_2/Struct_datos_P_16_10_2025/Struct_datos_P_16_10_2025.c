...
void asignarCadenaMinusculas(char *, char *);
...
void asignarCadenaMinusculas(char *c, char *cR)
{
    strcpy(cR, c);
...
void agregarLista2(DP *p, DP *p2)
{
    ...
    {
        int repetido = 0;
        asignarCadenaMinusculas(p[i].lastName, temp1);
        for (int j = 0; j < 15; j++)
        {
            if (i != j)
            {
                asignarCadenaMinusculas(p[j].lastName, temp2);
