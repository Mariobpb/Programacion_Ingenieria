...
lo mismo que "lista de personas 1", pero ahora se debe guardar en un archivo binario cada elemento
del arreglo de estructura.
...
int main() {
    ...
    FILE *arc = fopen("C:\\Users\\mario\\OneDrive\\Documentos\\CETI\\Ingenieria\\Programacion_Ingenieria\\Programacion_Estructurada\\Parcial_3\\Tareas\\lista_de_personas_2\\personas.bin", "wb");
    ...
    fwrite(personas, sizeof(Persona), MAX_PERSONAS, arc);
    fclose(arc);
